...
{
    public class RoboMovement: IRoboMovement
    {
        public Direction Direction { get; set; }
        public Position Position { get; set; }

        // Sets the Robo's position and direction.
        ...
        // Determines the next position of the Robo based on the direction it's currently facing.
        ...
        // Rotates the direction of the Robo 90 degreesto the left.
        public void RotateLeft()
        {
            Rotate(-1);
        }

        // Rotates the direction of the Robo 90 degrees to the right.
        public void RotateRight()
        {
            Rotate(1);
        }

        // Determines the new direction of the Robo.
